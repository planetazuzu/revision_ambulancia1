...
# 🚀 Script de Despliegue para AmbuReview - Puerto 9990 (Backend) y 3001 (Frontend)
...
if [ ! -f .env ]; then
    print_warning "Archivo .env no encontrado. Creando desde env.port9990-3001..."
    cp env.port9990-3001 .env
    print_success "Archivo .env creado para puertos 9990 y 3001"
else
...
print_header "Construyendo y levantando servicios en puertos 9990 y 3001..."
if command -v docker-compose &> /dev/null; then
...
check_service "http://localhost:3001" "Frontend (Puerto 3001)"

# Mostrar información de acceso
echo ""
print_success "🎉 ¡Despliegue en puertos 9990 y 3001 completado!"
echo ""
...
echo -e "  ${BLUE}Ver logs:${NC} docker compose -f docker-compose.port9990-3001.yml logs -f [servicio]"
echo -e "  ${BLUE}Parar servicios:${NC} docker compose -f docker-compose.port9990-3001.yml down"
echo -e "  ${BLUE}Reiniciar servicios:${NC} docker compose -f docker-compose.port9990-3001.yml restart"
echo -e "  ${BLUE}Acceder a base de datos:${NC} docker compose -f docker-compose.port9990-3001.yml exec db psql -U app -d appdb"
echo ""
print_success "¡Sistema AmbuReview listo en puertos 9990 y 3001! 🚀"
