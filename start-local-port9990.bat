@echo off
REM 🚀 Script para ejecutar AmbuReview sin Docker - Puerto 9990
echo 🚀 Iniciando AmbuReview en modo local en puerto 9990...
echo ================================================
...
echo.
echo [SUCCESS] 🎉 ¡AmbuReview iniciado en modo local en puerto 9990!
echo.
